...
# parser.add_argument('--n_classes', default=2, help='number of classes to be selected (randomly) in each episode')
...
# parser.add_argument('--image_width', default=32)
# parser.add_argument('--image_height', default=32)
...
# parser.add_argument('--n_train_classes', default=3500)
# parser.add_argument('--n_test_classes', default=960)
